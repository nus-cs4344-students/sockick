...
function SockickClient() {
            ...
            socket.onmessage = function(e) {
                ...
                switch (message.type) {
                    ...
                    case "updateVelocity":
                        ...
                        if (stopandwait) {
                            var v = calculateBallSpeed(message.ballVX,message.ballVY);
                            ball.vx = v.vx;
                            ball.vy = v.vy;
                            stopandwait = false;
                        } else {
    ...
    var calculateBallSpeed = function(vx0, vy0) {

        var distance = Pong.HEIGHT - 2*Paddle.HEIGHT - Ball.HEIGHT;
        var t0 = Math.abs(distance/vy0/Pong.FRAME_RATE);
        var t = t0 - delay/1000 + PongClient.LOCALLAG/1000;
